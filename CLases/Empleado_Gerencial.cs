...
{
    public class Empleado_Gerencial : IEmpleados
    {
        ...
        //public Empleado_Gerencial(string cedula, string codigo, string nombre, string apellido, string email, string telefono, string departamento, string cargo, int precio_hora, string horas_trabajo, double salarioN)
        //{
        //    this.cedula = cedula;
        //    this.codigo = codigo;
        //    this.nombre = nombre;
